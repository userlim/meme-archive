...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-[#191F28] mb-8">Privacy Policy</h1>
      <div className="prose prose-invert prose-sm max-w-none text-[#8B95A1] space-y-4">
        <p>Last updated: March 30, 2026</p>
        <h2 className="text-xl font-semibold text-[#191F28] mt-6">Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-[#191F28] mt-6">Cookies</h2>
        ...
        <h2 className="text-xl font-semibold text-[#191F28] mt-6">Data Retention</h2>
