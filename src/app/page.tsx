    ...
    <>
      ...
      <section className="relative overflow-hidden py-10 sm:py-14">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-[var(--text-muted)] text-sm sm:text-base max-w-xl mx-auto mb-5">
            {locale === 'ko'
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              <svg className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-secondary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {playingId && (
        <section className="max-w-4xl mx-auto px-4 mb-8">
          ...
          <button onClick={() => setPlayingId(null)} className="mt-2 text-sm text-[var(--text-muted)] hover:text-white transition">
            {locale === 'ko' ? '닫기' : 'Close'}
          </button>
        </section>
      )}
                  ...
                  return (
                    <button key={video.id} onClick={() => handlePlayTrending(video)}
                      ...
                      <div className="relative">
                        ...
                        {video.ageHours < 24 && (
                          <span className="absolute top-1.5 right-1.5 bg-emerald-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full">NEW</span>
                        )}
                        {video.duration && (
                      ...
                      <div className="p-2">
                        <h3 className={`font-medium text-xs line-clamp-2 ${watched ? 'text-[var(--text-muted)]' : 'text-white'}`}>{video.title}</h3>
                        <div className="flex items-center gap-1 text-[var(--text-secondary)] text-[10px] mt-1">
      ...
      <section id="about-section" className="mt-8 max-w-3xl mx-auto px-4">
        ...
        <p className="text-[var(--text-secondary)] leading-relaxed">Browse and discover the internet's best memes in one organized archive. From classic reaction images to the latest viral trends, our curated collection covers every meme category. Search by keyword, browse by category, or explore what's trending. Save and share your favorites instantly.</p>
      </section>
      ...
      <section id="content-depth-section" className="mt-20 max-w-3xl mx-auto px-6 relative z-[1]">
        <h2 className="text-h2 mb-6 text-[var(--text-primary)]">Complete Guide</h2>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">What Makes a Meme Go Viral?</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">The History of Internet Memes</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Major Meme Categories Explained</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Memes as Cultural Commentary</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Copyright and Fair Use in Meme Culture</h3>
      ...
      <section id="faq-section" className="mt-12 max-w-3xl mx-auto px-4">
        <h2 className="text-h2 mb-6 text-[var(--text-primary)]">Frequently Asked Questions</h2>
            ...
            <div className="mb-4">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">How many memes are in the archive?</h3>
              <p className="text-[var(--text-secondary)]">Our meme archive contains thousands of curated memes organized by category including reaction memes, classic memes, trending memes, and more. The collection is regularly updated with new content.</p>
            </div>
            <div className="mb-4">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Can I search for specific memes?</h3>
              <p className="text-[var(--text-secondary)]">Yes, use the search function to find memes by name, description, or category. You can also browse by trending, newest, or most popular to discover new favorites.</p>
            </div>
            <div className="mb-4">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Are these memes free to use?</h3>
              <p className="text-[var(--text-secondary)]">The memes in our archive are shared for personal entertainment and social media use. Most internet memes fall under fair use for non-commercial purposes, but always credit original creators when possible.</p>
            </div>
            <div className="mb-4">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">How do I save or share a meme?</h3>
              <p className="text-[var(--text-secondary)]">Click on any meme to view it in full size, then right-click to save or use the share button to copy the link. You can share directly to social media platforms.</p>
            </div>
      </section>
